...
9. [*MNS (Imitation MarketPlace computers). Tech: Spring Cloud (Config, Eureka Server, OpenFeign), Spring (Boot, REST API, Integration, Data), Lombok, PostgreSQL, TestNG, Mockito, Java Web Tokens Security with IdToken Cookie, Apache POI*](https://github.com/Frostetsky/MNS)
10. [*MAGNIT cosmetics (Global Project). Tech: Spring Cloud (Config, Eureka Server, OpenFeign, LoadBalancer, Reslience4j, Sleuth, API Gateway, Apache Kafka, Authorization Server with Keycloak, OAuth 2.0 and JWT), Spring (Boot, REST API, Data, JDBC), Lombok, PostgreSQL, TestNG, H2, Mockito.*] /TODO!
---
